...
.method private silenceRingerInternal()V
    ...
    const-string v2, "com.leadcore.intent.action.SHUT_UP_RINGING"
...
.method public doSimAuth(Ljava/lang/String;)Landroid/os/Bundle;
    ...
    .prologue
    .line 1074
    const-string v0, "enter doSimAuth"
...
.method public getIccCardRecordInfo(I)Landroid/telephony/IccCardInfo;
    .locals 2
    .parameter "infoId"

    .prologue
    .line 539
    new-instance v0, Lcom/android/phone/PhoneInterfaceManager$ReadCardRecord;
    ...
    invoke-direct {v0, v1}, Lcom/android/phone/PhoneInterfaceManager$ReadCardRecord;-><init>(Lcom/android/internal/telephony/IccCard;)V

    .line 540
    .local v0, readCardRecord:Lcom/android/phone/PhoneInterfaceManager$ReadCardRecord;
    invoke-virtual {v0}, Lcom/android/phone/PhoneInterfaceManager$ReadCardRecord;->start()V

    .line 541
    invoke-virtual {v0, p1}, Lcom/android/phone/PhoneInterfaceManager$ReadCardRecord;->getInfo(I)Landroid/telephony/IccCardInfo;
...
.method public getIccCardType()I
    ...
    invoke-virtual {v0}, Lcom/android/internal/telephony/IccCard;->getIccCardType()I
...
.method public getIccPuk1Blocked()Z
    ...
    invoke-virtual {v0}, Lcom/android/internal/telephony/IccCard;->getIccPuk1Blocked()Z
...
.method public getIpNumber()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lcom/android/phone/PhoneApp;->getIpNumber()Ljava/lang/String;
...
.method public getLacCid(I)Ljava/lang/String;
    ...
    const-string v9, "enter getLacCid, BDSType = "
    ...
    invoke-interface {v8}, Lcom/android/internal/telephony/Phone;->getCellLocation()Landroid/telephony/CellLocation;
    ...
    .line 1034
    .local v2, gsmCL:Landroid/telephony/gsm/GsmCellLocation;
    const/4 v8, 0x0
    ...
    const-string v9, "getLacCid, mcc.substring(0, 0) = "
    ...
    const-string v9, "!!!!!getLacCid, test = 0"
    ...
    const-string v9, "getLacCid, final   mcc = "
...
.method public getSpeedDialNumber(I)Ljava/lang/String;
    ...
    invoke-virtual {v0, p1}, Lcom/android/phone/PhoneApp;->getSpeedDialNumber(I)Ljava/lang/String;
...
.method public isIccCardReady()Z
    ...
    invoke-virtual {v0}, Lcom/android/internal/telephony/IccCard;->isIccCardReady()Z
...
.method public shutDownRadio()V
    ...
    invoke-interface {v0, v1}, Lcom/android/internal/telephony/Phone;->shutDownRadio(Landroid/os/Message;)V
...
.method public supplyPin(Ljava/lang/String;)I
    .locals 2
    .parameter "pin"
...
.method public supplyPuk(Ljava/lang/String;Ljava/lang/String;)I
    .locals 2
    .parameter "puk"
    .parameter "pin"
...
.method public getScAddress()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Landroid/telephony/SmsManager;->getSmsCenter()Ljava/lang/String;
...
.method public setScAddress(Ljava/lang/String;)V
    ...
    .line 180
    .local v0, smsManager:Landroid/telephony/SmsManager;
    invoke-virtual {v0, v1}, Landroid/telephony/SmsManager;->setSmsCenter(Ljava/lang/String;)Z
