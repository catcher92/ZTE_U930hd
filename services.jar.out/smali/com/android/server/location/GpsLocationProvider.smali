...
.field private static final PROPERTIES_FILE_AGPS:Ljava/lang/String; = "/data/agps.conf"
...
.method private reportLocation(IDDDFFFJ)V
    ...
    iget-boolean v13, v0, Lcom/android/server/location/GpsLocationProvider;->gps_synctime_up:Z
    ...
    iget v13, v0, Lcom/android/server/location/GpsLocationProvider;->course_up:I
    ...
    iget-wide v13, v0, Lcom/android/server/location/GpsLocationProvider;->mLastFixTime:J

    sub-long v11, p11, v13
    ...
    const-string v14, "SystemClock.setCurrentTimeMillis(timestamp) up"
    ...
    iput-boolean v13, v0, Lcom/android/server/location/GpsLocationProvider;->gps_synctime_up:Z
    ...
    iput v13, v0, Lcom/android/server/location/GpsLocationProvider;->course_up:I
    ...
    invoke-virtual {v13, v0, v1}, Landroid/location/Location;->setAltitude(D)V
    ...
    invoke-virtual {v13, v0}, Landroid/location/Location;->setSpeed(F)V
    ...
    invoke-virtual {v13, v0}, Landroid/location/Location;->setBearing(F)V
    ...
    iget-object v13, v0, Lcom/android/server/location/GpsLocationProvider;->mLocationManager:Landroid/location/ILocationManager;

    move-object/from16 v0, p0

    iget-object v15, v0, Lcom/android/server/location/GpsLocationProvider;->mLocation:Landroid/location/Location;

    const/16 v16, 0x0

    move/from16 v0, v16

    invoke-interface {v13, v15, v0}, Landroid/location/ILocationManager;->reportLocation(Landroid/location/Location;Z)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_0
    ...
    iput-wide v13, v0, Lcom/android/server/location/GpsLocationProvider;->mLastFixTime:J
    ...
    iget-wide v15, v0, Lcom/android/server/location/GpsLocationProvider;->mFixRequestTime:J
    ...
    iput v13, v0, Lcom/android/server/location/GpsLocationProvider;->mTTFF:I

    .line 1159
    move-object/from16 v0, p0

    iget-object v14, v0, Lcom/android/server/location/GpsLocationProvider;->mListeners:Ljava/util/ArrayList;
    ...
    :try_start_4
    iget-object v13, v7, Lcom/android/server/location/GpsLocationProvider$Listener;->mListener:Landroid/location/IGpsStatusListener;

    move-object/from16 v0, p0

    iget v15, v0, Lcom/android/server/location/GpsLocationProvider;->mTTFF:I

    invoke-interface {v13, v15}, Landroid/location/IGpsStatusListener;->onFirstFix(I)V
    :try_end_4
    ...
    invoke-virtual {v13}, Landroid/location/Location;->removeAltitude()V
    ...
    invoke-virtual {v13}, Landroid/location/Location;->removeSpeed()V
    ...
    invoke-virtual {v13}, Landroid/location/Location;->removeBearing()V
    ...
    invoke-virtual {v13}, Landroid/location/Location;->removeAccuracy()V
    ...
    const-string v15, "RemoteException calling reportLocation"
    ...
    .restart local v7       #listener:Lcom/android/server/location/GpsLocationProvider$Listener;
    ...
    const-string v14, "PREF_KEY_GPS_TIME_SYNC_VALUE"
    ...
    const-string v15, "Sync system time:"
    ...
    iget-wide v15, v0, Lcom/android/server/location/GpsLocationProvider;->mLastFixTime:J

    invoke-virtual/range {v14 .. v16}, Ljava/lang/StringBuilder;->append(J)Ljava/lang/StringBuilder;

    move-result-object v14

    const-string v15, "(ms) with gps time:"
    ...
    iget-boolean v13, v0, Lcom/android/server/location/GpsLocationProvider;->mSingleShot:Z
    ...
    iget-boolean v13, v0, Lcom/android/server/location/GpsLocationProvider;->mStarted:Z

    if-eqz v13, :cond_e

    move-object/from16 v0, p0

    iget v13, v0, Lcom/android/server/location/GpsLocationProvider;->mStatus:I
    ...
    invoke-direct {v0, v13}, Lcom/android/server/location/GpsLocationProvider;->hasCapability(I)Z
    ...
    iget v13, v0, Lcom/android/server/location/GpsLocationProvider;->mFixInterval:I
    ...
    iget-object v13, v0, Lcom/android/server/location/GpsLocationProvider;->mAlarmManager:Landroid/app/AlarmManager;

    move-object/from16 v0, p0

    iget-object v14, v0, Lcom/android/server/location/GpsLocationProvider;->mTimeoutIntent:Landroid/app/PendingIntent;
    ...
    const-string v14, "reportLocation --GPS_FIX_CHANGE_ACTION-2-in-"
    ...
    const-string v15, "reportLocation --GPS_FIX_CHANGE_ACTION-2-in-now="
    ...
    const-string v15, "reportLocation --GPS_FIX_CHANGE_ACTION-2-in-timestamp="
    ...
    const-string v15, "reportLocation --GPS_FIX_CHANGE_ACTION-2-in-gpstime="
    ...
    const-string v14, "gps_synctime_enable"
    ...
    iget v14, v0, Lcom/android/server/location/GpsLocationProvider;->mSvCount:I

    move-object/from16 v0, p0

    invoke-direct {v0, v13, v14}, Lcom/android/server/location/GpsLocationProvider;->updateStatus(II)V

    .line 1215
    .end local v3           #gpstime:J
...
.method private startNavigating(Z)V
    ...
    .line 1004
    .local v8, ext:Landroid/os/Bundle;
    const-string v0, "ephemeris"

    invoke-virtual {v8, v0, v12}, Landroid/os/Bundle;->putBoolean(Ljava/lang/String;Z)V
    ...
    .line 1007
    invoke-direct {p0, v8}, Lcom/android/server/location/GpsLocationProvider;->deleteAidingData(Landroid/os/Bundle;)Z

    .line 1008
    const-string v0, "GpsLocationProvider"

    const-string v1, "Cold start mode"

    invoke-static {v0, v1}, Landroid/util/Log;->e(Ljava/lang/String;Ljava/lang/String;)I

    .line 1016
    .end local v8           #ext:Landroid/os/Bundle;
    :goto_1
    const/16 v0, 0xa
    ...
    const-string v0, "/data/agps.conf"
    ...
    const-string v4, "the mPositionMode is "
    ...
    .line 996
    :cond_3
    invoke-direct {p0, v13}, Lcom/android/server/location/GpsLocationProvider;->hasCapability(I)Z
    ...
    const-string v1, "Use the default start mode."
    ...
    const-string v1, "Could not open AGPS configuration file /data/agps.conf"
    ...
    invoke-virtual {v0, v13, v1, v2, v4}, Landroid/app/AlarmManager;->set(IJLandroid/app/PendingIntent;)V
