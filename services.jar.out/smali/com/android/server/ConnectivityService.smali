...
.field private static final ROUTE_PRIORITY_LESS_PRIVILEGED:I = 0x2
...
.method public constructor <init>(Landroid/content/Context;Landroid/os/INetworkManagementService;Landroid/net/INetworkStatsService;Landroid/net/INetworkPolicyManager;)V
    ...
    const v3, #string@config_default_dns_server#t
    ...
    const v3, #integer@config_networkTransitionTimeout#t
...
.method private addMetricDefaultRoute(Landroid/net/LinkProperties;I)V
    .locals 4
    .parameter "lp"
    .parameter "metric"
    ...
    const-string v2, "addMetricDefaultRoute(): add a default route with metric = "
    ...
    invoke-interface {v1, v2, p2, v3}, Landroid/os/INetworkManagementService;->addMetricRoute(Ljava/lang/String;ILjava/lang/String;)V
    :try_end_0
...
.method private addMetricRouteToAddress(Landroid/net/LinkProperties;ILjava/lang/String;)V
    .locals 3
    .parameter "lp"
    .parameter "metric"
    .parameter "addr"
    ...
    const-string v2, "addMetricRouteToAddress(): add a dest route with ip = "
    ...
    invoke-interface {v1, v2, p2, p3}, Landroid/os/INetworkManagementService;->addMetricRoute(Ljava/lang/String;ILjava/lang/String;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method private handleApplyDefaultProxy(Landroid/net/ProxyProperties;)V
    ...
    .line 3008
    const-string v0, "sending Proxy Broadcast mDefaultProxy == proxy"
...
.method private handleConnectivityChange(IZ)V
    ...
    .line 2141
    invoke-direct {p0, v7, v1, p1}, Lcom/android/server/ConnectivityService;->updateRoutes(Landroid/net/LinkProperties;Landroid/net/LinkProperties;I)Z
...
.method private isValidThirdAppFeature(Ljava/lang/String;)Z
    .locals 2
    .parameter "feature"
...
.method private removeMetricDefaultRoute(Landroid/net/LinkProperties;I)V
    .locals 4
    .parameter "lp"
    .parameter "metric"
    ...
    const-string v2, "removeMetricDefaultRoute(): remove a default route with metric = "
    ...
    invoke-interface {v1, v2, p2, v3}, Landroid/os/INetworkManagementService;->removeMetricRoute(Ljava/lang/String;ILjava/lang/String;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v2, "Exception trying to add a metric route: "
...
.method private removeMetricRouteToAddress(Landroid/net/LinkProperties;ILjava/lang/String;)V
    .locals 3
    .parameter "lp"
    .parameter "metric"
    .parameter "addr"
    ...
    const-string v2, "removeMetricRouteToAddress(): remove a dest route with p = "
    ...
    invoke-interface {v1, v2, p2, p3}, Landroid/os/INetworkManagementService;->removeMetricRoute(Ljava/lang/String;ILjava/lang/String;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method private updateRoutes(Landroid/net/LinkProperties;Landroid/net/LinkProperties;I)Z
    ...
    .line 2193
    .local v10, routesChanged:Z
    if-eqz p2, :cond_0

    invoke-virtual/range {p2 .. p2}, Landroid/net/LinkProperties;->getHttpProxy()Landroid/net/ProxyProperties;
    ...
    .line 2196
    .local v7, persistPoxy:Landroid/net/ProxyProperties;
    if-eqz v3, :cond_2
    ...
    .line 2201
    .local v1, apnTypeName:Ljava/lang/String;
    const/4 v11, 0x0

    .line 2202
    .local v11, routesToAdd:Ljava/util/Collection;,"Ljava/util/Collection<Landroid/net/RouteInfo;>;"
    ...
    .line 2203
    .local v2, dnsDiff:Landroid/net/LinkProperties$CompareResult;,"Landroid/net/LinkProperties$CompareResult<Ljava/net/InetAddress;>;"
    new-instance v9, Landroid/net/LinkProperties$CompareResult;

    invoke-direct {v9}, Landroid/net/LinkProperties$CompareResult;-><init>()V

    .line 2204
    .local v9, routeDiff:Landroid/net/LinkProperties$CompareResult;,"Landroid/net/LinkProperties$CompareResult<Landroid/net/RouteInfo;>;"
    if-eqz p2, :cond_8

    .line 2206
    move-object/from16 v0, p2

    invoke-virtual {v0, p1}, Landroid/net/LinkProperties;->compareRoutes(Landroid/net/LinkProperties;)Landroid/net/LinkProperties$CompareResult;
    ...
    :cond_3
    :goto_2
    iget-object v12, v9, Landroid/net/LinkProperties$CompareResult;->removed:Ljava/util/Collection;
    ...
    iget-object v12, v9, Landroid/net/LinkProperties$CompareResult;->added:Ljava/util/Collection;
    ...
    invoke-direct {p0, v0, v8, v12}, Lcom/android/server/ConnectivityService;->removeRoute(Landroid/net/LinkProperties;Landroid/net/RouteInfo;Z)Z

    goto :goto_4

    .line 2193
    .end local v1           #apnTypeName:Ljava/lang/String;
    .end local v2           #dnsDiff:Landroid/net/LinkProperties$CompareResult;,"Landroid/net/LinkProperties$CompareResult<Ljava/net/InetAddress;>;"
    .end local v3           #hasProxy:Z
    .end local v4           #i$:Ljava/util/Iterator;
    .end local v7           #persistPoxy:Landroid/net/ProxyProperties;
    .end local v8           #r:Landroid/net/RouteInfo;
    .end local v9           #routeDiff:Landroid/net/LinkProperties$CompareResult;,"Landroid/net/LinkProperties$CompareResult<Landroid/net/RouteInfo;>;"
    .end local v11           #routesToAdd:Ljava/util/Collection;,"Ljava/util/Collection<Landroid/net/RouteInfo;>;"
    :cond_6
    const/4 v3, 0x0
    ...
    .line 2197
    .restart local v3       #hasProxy:Z
    .restart local v7       #persistPoxy:Landroid/net/ProxyProperties;
    :cond_7
    invoke-virtual/range {p2 .. p2}, Landroid/net/LinkProperties;->getHttpProxy()Landroid/net/ProxyProperties;
    ...
    .line 2208
    .restart local v1       #apnTypeName:Ljava/lang/String;
    .restart local v2       #dnsDiff:Landroid/net/LinkProperties$CompareResult;,"Landroid/net/LinkProperties$CompareResult<Ljava/net/InetAddress;>;"
    .restart local v9       #routeDiff:Landroid/net/LinkProperties$CompareResult;,"Landroid/net/LinkProperties$CompareResult<Landroid/net/RouteInfo;>;"
    .restart local v11       #routesToAdd:Ljava/util/Collection;,"Ljava/util/Collection<Landroid/net/RouteInfo;>;"
    :cond_8
    if-eqz p1, :cond_3
    ...
    iput-object v12, v9, Landroid/net/LinkProperties$CompareResult;->added:Ljava/util/Collection;
    ...
    iput-object v12, v2, Landroid/net/LinkProperties$CompareResult;->added:Ljava/util/Collection;
    ...
    .restart local v8       #r:Landroid/net/RouteInfo;
    :cond_a
    const/4 v12, 0x4
    ...
    iget v12, v12, Landroid/net/NetworkConfig;->priority:I
    ...
    invoke-direct {p0, v0, v12, v13}, Lcom/android/server/ConnectivityService;->removeMetricRouteToAddress(Landroid/net/LinkProperties;ILjava/lang/String;)V
    ...
    invoke-direct {p0, p1, v8, v12}, Lcom/android/server/ConnectivityService;->addRoute(Landroid/net/LinkProperties;Landroid/net/RouteInfo;Z)Z
    ...
    invoke-direct {p0, p1, v12, v13}, Lcom/android/server/ConnectivityService;->addMetricRouteToAddress(Landroid/net/LinkProperties;ILjava/lang/String;)V
    ...
    invoke-direct {p0, p1, v5}, Lcom/android/server/ConnectivityService;->addRouteToAddress(Landroid/net/LinkProperties;Ljava/net/InetAddress;)Z
    ...
    :cond_12
    iget-object v12, v2, Landroid/net/LinkProperties$CompareResult;->removed:Ljava/util/Collection;
    ...
    .end local v6           #oldDns:Ljava/net/InetAddress;
    :cond_13
    iget-object v12, v2, Landroid/net/LinkProperties$CompareResult;->added:Ljava/util/Collection;
...
.method convertFeatureToNetworkType(ILjava/lang/String;)I
    ...
    .line 3106
    :cond_c
    invoke-direct {p0, p2}, Lcom/android/server/ConnectivityService;->isValidThirdAppFeature(Ljava/lang/String;)Z
...
.method public requestRouteToHostAddress(I[B)Z
    ...
    invoke-direct {p0, v1, v4, v5}, Lcom/android/server/ConnectivityService;->addMetricRouteToAddress(Landroid/net/LinkProperties;ILjava/lang/String;)V
    :try_end_0
...
.method public startUsingNetworkFeature(ILjava/lang/String;Landroid/os/IBinder;)I
    ...
    const-string v15, "startUsingNetworkFeature for net "
    ...
    iget-object v14, v0, Lcom/android/server/ConnectivityService;->mProtectedNetworks:Ljava/util/List;
    ...
    instance-of v14, v9, Landroid/net/MobileDataStateTracker;
    ...
    invoke-virtual {v14, v5}, Landroid/net/MobileDataStateTracker;->setPid(I)V
    ...
    const-string v15, "startUsingNetworkFeature, current calling Pid is "
    ...
    .line 1064
    const-string v14, "special network not available"
    ...
    .line 1065
    const-string v14, "enableDUNAlways"
    ...
    invoke-direct {v0, v13}, Lcom/android/server/ConnectivityService;->getRestoreDefaultNetworkDelay(I)I
    ...
    invoke-virtual {v12, v7}, Lcom/android/server/ConnectivityService$FeatureUser;->isSameUser(Lcom/android/server/ConnectivityService$FeatureUser;)Z
    ...
    invoke-virtual {v15, v0, v7}, Landroid/os/Handler;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
    ...
    invoke-direct {v0, v13}, Lcom/android/server/ConnectivityService;->handleDnsConfigurationChange(I)V

    .line 1105
    const-string v14, "special network already active"
    ...
    .line 1108
    :cond_a
    const-string v14, "special network already connecting"
    ...
    const-string v15, "startUsingNetworkFeature reconnecting to "
