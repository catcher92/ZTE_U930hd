...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/server/WifiService$WifiSleep;,
...
.field private static final GET_STA_TIME:I = 0x2710

.field private static final ICON_NETWORKS_AVAILABLE:I = 0x108053a

.field private static final IDLE_REQUEST:I = 0x0

.field private static final MESSAGE_OPEN_WIFI_AP:I = 0xf

.field private static final MESSAGE_WIFI_SLEEP:I = 0x10

.field private static final MINUTE_60:I = 0x3c

.field private static final MONITOR_REQUEST:I = 0x0

.field private static final NOT_CONNECTED_DEFAULT_IDLE_MS:J = 0xea60L
...
.field private static final fifteenMin:I = 0x5a

.field private static final fiveMin:I = 0x1e


# instance fields
.field private final NOTIFICATION_REPEAT_DELAY_MS:J

.field private getStaNum:I

.field private isturnoffwifi:Z
...
.field private mWifiSleep:Lcom/android/server/WifiService$WifiSleep;
...
.method constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {v6, p0, v10}, Lcom/android/server/WifiService$LockList;-><init>(Lcom/android/server/WifiService;Lcom/android/server/WifiService$1;)V
    ...
    .line 173
    iput v9, p0, Lcom/android/server/WifiService;->getStaNum:I

    .line 176
    iput-boolean v9, p0, Lcom/android/server/WifiService;->mWifiApSleepPolicyAlarmStarted:Z

    .line 190
    iput v9, p0, Lcom/android/server/WifiService;->mSleepPolicyTickCount:I
    ...
    invoke-direct {v6, v11, v9, v7, v8}, Landroid/net/NetworkInfo;-><init>(IILjava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v2, v6, v10}, Landroid/content/Intent;-><init>(Ljava/lang/String;Landroid/net/Uri;)V
    ...
    const-string v6, "com.android.server.WifiManager.action.ACTION_SMART_MONITOR"

    invoke-direct {v3, v6, v10}, Landroid/content/Intent;-><init>(Ljava/lang/String;Landroid/net/Uri;)V

    .line 431
    .local v3, monitorIntent:Landroid/content/Intent;
    iget-object v6, p0, Lcom/android/server/WifiService;->mContext:Landroid/content/Context;
    ...
    iput-object v6, p0, Lcom/android/server/WifiService;->mMonitorIntent:Landroid/app/PendingIntent;

    .line 438
    const-string v6, "WifiService"

    const-string v7, "ZTE Custom start !\n"
    ...
    const-string v6, "com.android.server.WifiManager.action.WIFI_AP_SLEEP_POLICY"

    invoke-direct {v4, v6, v10}, Landroid/content/Intent;-><init>(Ljava/lang/String;Landroid/net/Uri;)V

    .line 441
    .local v4, wifiApSleepPolicyIntent:Landroid/content/Intent;
    iget-object v6, p0, Lcom/android/server/WifiService;->mContext:Landroid/content/Context;

    invoke-static {v6, v9, v4, v9}, Landroid/app/PendingIntent;->getBroadcast(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;

    move-result-object v6

    iput-object v6, p0, Lcom/android/server/WifiService;->mWifiApSleepPolicyIntent:Landroid/app/PendingIntent;
    ...
    const-string v6, "android.intent.action.SOFTAP_START_POWERMODE_ALARM"

    invoke-virtual {v0, v6}, Landroid/content/IntentFilter;->addAction(Ljava/lang/String;)V

    .line 446
    const-string v6, "android.intent.action.SOFTAP_STOP_POWERMODE_ALARM"

    invoke-virtual {v0, v6}, Landroid/content/IntentFilter;->addAction(Ljava/lang/String;)V

    .line 447
    const-string v6, "android.intent.action.SOFTAP_SLEEPPOLICY_CHANGED"
    ...
    .line 592
    new-instance v6, Lcom/android/server/WifiService$WifiSleep;

    invoke-direct {v6, p0, v10}, Lcom/android/server/WifiService$WifiSleep;-><init>(Lcom/android/server/WifiService;Lcom/android/server/WifiService$1;)V

    iput-object v6, p0, Lcom/android/server/WifiService;->mWifiSleep:Lcom/android/server/WifiService$WifiSleep;
...
.method static synthetic access$2100(Lcom/android/server/WifiService;)Landroid/app/PendingIntent;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$2200(Lcom/android/server/WifiService;)Landroid/app/AlarmManager;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$2500(Lcom/android/server/WifiService;)J
    .locals 2
    .parameter "x0"

    .prologue
    .line 98
    iget-wide v0, p0, Lcom/android/server/WifiService;->wifiHaveData:J
...
.method static synthetic access$2502(Lcom/android/server/WifiService;J)J
    ...
    .prologue
    .line 98
    iput-wide p1, p0, Lcom/android/server/WifiService;->wifiHaveData:J
...
.method static synthetic access$2600(Lcom/android/server/WifiService;)Z
    ...
    .prologue
    .line 98
    iget-boolean v0, p0, Lcom/android/server/WifiService;->isturnoffwifi:Z
...
.method static synthetic access$2602(Lcom/android/server/WifiService;Z)Z
    ...
    .prologue
    .line 98
    iput-boolean p1, p0, Lcom/android/server/WifiService;->isturnoffwifi:Z
...
.method static synthetic access$2800(Lcom/android/server/WifiService;Z)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$2902(Lcom/android/server/WifiService;I)I
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$3100(Lcom/android/server/WifiService;J)Z
    .locals 1
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$4800(Lcom/android/server/WifiService;)I
    ...
    .prologue
    .line 98
    iget v0, p0, Lcom/android/server/WifiService;->getStaNum:I
...
.method static synthetic access$4802(Lcom/android/server/WifiService;I)I
    ...
    .prologue
    .line 98
    iput p1, p0, Lcom/android/server/WifiService;->getStaNum:I

    return p1
.end method

.method static synthetic access$4808(Lcom/android/server/WifiService;)I
    .locals 2
    .parameter "x0"
    ...
    iput v1, p0, Lcom/android/server/WifiService;->getStaNum:I
...
.method static synthetic access$4900(Lcom/android/server/WifiService;)V
    ...
    .prologue
    .line 98
    invoke-direct {p0}, Lcom/android/server/WifiService;->turnoffWifi()V
...
.method static synthetic access$900(Lcom/android/server/WifiService;)I
    .locals 1
    .parameter "x0"
...
.method static synthetic access$902(Lcom/android/server/WifiService;I)I
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$910(Lcom/android/server/WifiService;)I
    .locals 2
    .parameter "x0"
...
.method private getWifiData()J
    ...
    const-string v2, "[getWifiData] wifiData = "
...
.method private isWifiChangeData(J)Z
    ...
    const-string v3, "[isWifiChangeData] wifiData = "
    ...
    const-string v3, "[isWifiChangeData] getWifiData()-wifiData = "
    ...
    iput-wide v1, p0, Lcom/android/server/WifiService;->wifiHaveData:J
...
.method private declared-synchronized reportStartWorkSource()V
    ...
    invoke-static {v1}, Lcom/android/server/WifiService$LockList;->access$3300(Lcom/android/server/WifiService$LockList;)Ljava/util/List;
...
.method private sendWifiApSleepPolicyAlarmBroadcast(Z)V
    ...
    const-string v3, "sendWifiApSleepPolicyAlarmBroadcast :"
...
.method private setApSleepPolicyAlarm(Z)V
    ...
    const-string v2, "wifi_ap_sleep_policy"
    ...
    const-string v3, "setApSleepPolicyAlarm value="
...
.method private turnoffWifi()V
    ...
    invoke-direct {p0, v0, v1}, Lcom/android/server/WifiService;->isWifiChangeData(J)Z
    ...
    .line 1884
    iput-boolean v2, p0, Lcom/android/server/WifiService;->mDeviceIdle:Z
    ...
    const-string v1, "[turnoffWifi] turn off wifi"

    invoke-static {v0, v1}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I

    .line 1887
    iput-boolean v2, p0, Lcom/android/server/WifiService;->isturnoffwifi:Z
...
.method private updateWifiState()V
    ...
    invoke-static {v5}, Lcom/android/server/WifiService$LockList;->access$3400(Lcom/android/server/WifiService$LockList;)Z
    ...
    const-string v7, "updateWifiState: lockHeld = "
    ...
    invoke-static {v5}, Lcom/android/server/WifiService$LockList;->access$3500(Lcom/android/server/WifiService$LockList;)I
    ...
    const-string v7, "updateWifiState: 1:mEmergencyCallbackMode = "
    ...
    const-string v7, " strongestLockMode = "
    ...
    const-string v7, "updateWifiState: 2:mEmergencyCallbackMode = "
    ...
    const-string v6, "updateWifiState:  setDriverStart (mEmergencyCallbackMode) = "
    ...
    const-string v5, "updateWifiState:  setWifiEnabled(false) "
...
.method public setWifiApEnabled(Landroid/net/wifi/WifiConfiguration;Z)V
    ...
    .line 775
    .local v0, shouldStartApSleepPolicyAlarm:Z
    const/4 v2, 0x2
    ...
    const-string v4, "setWifiApEnabled shouldStartApSleepPolicyAlarm="
    ...
    .line 780
    invoke-direct {p0, p2}, Lcom/android/server/WifiService;->sendWifiApSleepPolicyAlarmBroadcast(Z)V
    ...
    .line 782
    :cond_1
    invoke-direct {p0, v5}, Lcom/android/server/WifiService;->sendWifiApSleepPolicyAlarmBroadcast(Z)V
...
.method public updateWifiLockWorkSource(Landroid/os/IBinder;Landroid/os/WorkSource;)V
    ...
    invoke-static {v6, p1}, Lcom/android/server/WifiService$LockList;->access$4400(Lcom/android/server/WifiService$LockList;Landroid/os/IBinder;)I
    ...
    #getter for: Lcom/android/server/WifiService$LockList;->mList:Ljava/util/List;
    invoke-static {v6}, Lcom/android/server/WifiService$LockList;->access$3300(Lcom/android/server/WifiService$LockList;)Ljava/util/List;
