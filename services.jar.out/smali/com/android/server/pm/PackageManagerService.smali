...
.method private copyThirdApps(Ljava/io/File;Ljava/io/File;)Z
    .locals 9
    .parameter "srcFile"
    .parameter "destDir"
    ...
    const-string v6, "invalid arguments for movePreinstallApkFile()"
    ...
    const-string v6, "copy file faild!"
    ...
    const-string v7, "copy file faild! due to:"
    ...
    const-string v7, "setPermission faild! path = "
    ...
    const-string v7, "setPermission faild!due to:"
...
.method private installThirdApps()V
    .locals 10
    ...
    const-string v7, "/system/third_app"

    invoke-direct {v6, v7}, Ljava/io/File;-><init>(Ljava/lang/String;)V

    .line 1188
    .local v6, storeDir:Ljava/io/File;
    ...
    const-string v8, "/system/third_app is not exist"
    ...
    .line 1195
    .local v0, apkFilesNames:[Ljava/lang/String;
    if-nez v0, :cond_2

    .line 1196
    const-string v7, "PackageManager"

    const-string v8, "apk file name is null"
    ...
    .line 1208
    invoke-direct {p0, v5, v1}, Lcom/android/server/pm/PackageManagerService;->copyThirdApps(Ljava/io/File;Ljava/io/File;)Z
