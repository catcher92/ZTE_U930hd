...
.field static final HEADER_STR:Ljava/lang/String; = "text/vnd.wap.wml;q=0.8, text/xml, text/html, application/xhtml+xml, image/png, text/plain, */*;q=0.8"
...
.method private populateStaticHeaders()V
    ...
    .prologue
    .line 367
    iget-object v1, p0, Landroid/webkit/FrameLoader;->mHeaders:Ljava/util/Map;
    ...
    const-string/jumbo v3, "text/vnd.wap.wml;q=0.8, text/xml, text/html, application/xhtml+xml, image/png, text/plain, */*;q=0.8"
    ...
    const-string/jumbo v3, "utf-8, gb2312, gbk, iso-8859-1, utf-16, *;q=0.7"
    ...
    invoke-virtual {v1}, Landroid/webkit/WebSettings;->getUserAgentProfile()Ljava/lang/String;
    ...
    invoke-virtual {v3}, Landroid/webkit/WebSettings;->getUserAgentProfile()Ljava/lang/String;
