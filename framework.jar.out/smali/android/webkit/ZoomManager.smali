...
.method private zoom(F)Z
    ...
    invoke-virtual {v3}, Landroid/webkit/WebView;->switchOutDrawHistory()V
    ...
    invoke-virtual {v3}, Landroid/webkit/WebView;->getViewHeight()I
    ...
    iput v3, p0, Landroid/webkit/ZoomManager;->mZoomCenterY:F
    ...
    invoke-virtual {v1}, Landroid/webkit/WebSettings;->isNarrowColumnLayout()Z
    ...
    :cond_2
    invoke-virtual {p0, v0, v2}, Landroid/webkit/ZoomManager;->startZoomAnimation(FZ)Z
...
.method private zoomToReadingLevelOrMore()V
    ...
    invoke-virtual {v4, v6, v7, v8}, Landroid/webkit/WebView;->nativeGetBlockLeftEdge(IIF)I
    ...
    :goto_0
    invoke-virtual {v6, v4}, Landroid/webkit/WebView;->contentToViewX(I)I
    ...
    invoke-static {v4, v3}, Landroid/webkit/ZoomManager;->exceedsMinScaleIncrement(FF)Z
    ...
    invoke-virtual {p0, v3, v4}, Landroid/webkit/ZoomManager;->startZoomAnimation(FZ)Z
