...
.field private static mReadErrorTry:I
...
.method static constructor <clinit>()V
    ...
    .line 326
    sput v3, Landroid/media/MediaScanner;->mReadErrorTry:I
...
.method static synthetic access$1100()I
    ...
    .prologue
    .line 120
    sget v0, Landroid/media/MediaScanner;->mReadErrorTry:I
...
.method static synthetic access$1102(I)I
    ...
    .prologue
    .line 120
    sput p0, Landroid/media/MediaScanner;->mReadErrorTry:I
...
.method static synthetic access$1108()I
    ...
    sput v1, Landroid/media/MediaScanner;->mReadErrorTry:I
...
.method private postscan([Ljava/lang/String;)V
    ...
    const-string v11, "   postscan before fileMissing: "
    ...
    const-string v11, "   postscan after fileMissing: "
    ...
    const-string v11, "   postscan end fileMissing  end: "
...
.method public scanDirectories([Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v10, v4, Landroid/media/MediaScanner$FileCacheEntry;->mPath:Ljava/lang/String;
    ...
    .line 1244
    .local v17, testFile:Ljava/io/File;
    ...
    .end local v8           #iterator:Ljava/util/Iterator;,"Ljava/util/Iterator<Landroid/media/MediaScanner$FileCacheEntry;>;"
    .end local v9           #mediaFileType:Landroid/media/MediaFile$MediaFileType;
    .end local v10           #path:Ljava/lang/String;
    .end local v15           #start:J
    .end local v17           #testFile:Ljava/io/File;
    :catch_0
    move-exception v3
    ...
    .restart local v5       #fileMissing:Z
    .restart local v8       #iterator:Ljava/util/Iterator;,"Ljava/util/Iterator<Landroid/media/MediaScanner$FileCacheEntry;>;"
    .restart local v9       #mediaFileType:Landroid/media/MediaFile$MediaFileType;
    .restart local v10       #path:Ljava/lang/String;
    .restart local v15       #start:J
    .restart local v17       #testFile:Ljava/io/File;
    :cond_2
    :try_start_1
    ...
    .end local v7           #i:I
    .end local v8           #iterator:Ljava/util/Iterator;,"Ljava/util/Iterator<Landroid/media/MediaScanner$FileCacheEntry;>;"
    .end local v11           #prescan:J
    .end local v13           #scan:J
    .end local v15           #start:J
    :catch_1
    move-exception v3
