...
.method private startSemiView(I)V
    ...
    invoke-static {v8, v2, v1}, Landroid/widget/TextView;->access$invoke-getTransformedText-7a824c(Landroid/widget/TextView;II)Ljava/lang/CharSequence;

    move-result-object v8

    #setter for: Landroid/widget/TextView;->mSearchText:Ljava/lang/CharSequence;
    invoke-static {v7, v8}, Landroid/widget/TextView;->access$iput-mSearchText-95a0f1(Landroid/widget/TextView;Ljava/lang/CharSequence;)Ljava/lang/CharSequence;

    .line 10763
    iget-object v7, p0, Landroid/widget/TextView$ActionPopupWindow;->this$0:Landroid/widget/TextView;

    #getter for: Landroid/widget/TextView;->mSearchText:Ljava/lang/CharSequence;
    invoke-static {v7}, Landroid/widget/TextView;->access$iget-mSearchText-b1f518(Landroid/widget/TextView;)Ljava/lang/CharSequence;
    ...
    invoke-static {v7}, Landroid/widget/TextView;->access$invoke-viewportToContentHorizontalOffset-bc200d(Landroid/widget/TextView;)I
    ...
    invoke-static {v7}, Landroid/widget/TextView;->access$invoke-viewportToContentVerticalOffset-4ef85b(Landroid/widget/TextView;)I
    ...
    #getter for: Landroid/widget/TextView;->mSearchText:Ljava/lang/CharSequence;
    invoke-static {v8}, Landroid/widget/TextView;->access$iget-mSearchText-b1f518(Landroid/widget/TextView;)Ljava/lang/CharSequence;
    ...
    invoke-static {v7}, Landroid/widget/TextView;->access$invoke-stopSelectionActionMode-67c64f(Landroid/widget/TextView;)V
...
.method protected clipVertically(I)I
    ...
    invoke-static/range {v19 .. v19}, Landroid/widget/TextView;->access$iget-mSelectionActionMode-1c7fde(Landroid/widget/TextView;)Landroid/view/ActionMode;
    ...
    invoke-static/range {v19 .. v19}, Landroid/widget/TextView;->access$iget-mContext-3ebab7(Landroid/widget/TextView;)Landroid/content/Context;
    ...
    invoke-static/range {v19 .. v19}, Landroid/widget/TextView;->access$iget-mSpacingMult-a57516(Landroid/widget/TextView;)F
    ...
    invoke-static/range {v19 .. v19}, Landroid/widget/TextView;->access$iget-mSpacingAdd-fd82f6(Landroid/widget/TextView;)F
    ...
    #calls: Landroid/widget/TextView;->viewportToContentHorizontalOffset()I
    invoke-static/range {v19 .. v19}, Landroid/widget/TextView;->access$invoke-viewportToContentHorizontalOffset-bc200d(Landroid/widget/TextView;)I
    ...
    #calls: Landroid/widget/TextView;->viewportToContentVerticalOffset()I
    invoke-static/range {v19 .. v19}, Landroid/widget/TextView;->access$invoke-viewportToContentVerticalOffset-4ef85b(Landroid/widget/TextView;)I
    ...
    invoke-static {v0, v6, v7}, Landroid/widget/TextView;->access$invoke-isPositionVisible-02712e(Landroid/widget/TextView;II)Z
    ...
    invoke-static/range {v20 .. v20}, Landroid/widget/TextView;->access$iget-mTextSelectHandleRes-aa2635(Landroid/widget/TextView;)I
...
.method protected initContentView()V
    ...
    #getter for: Landroid/view/View;->mContext:Landroid/content/Context;
    invoke-static {v3}, Landroid/widget/TextView;->access$iget-mContext-3ebab7(Landroid/widget/TextView;)Landroid/content/Context;
...
.method public onClick(Landroid/view/View;)V
    ...
    invoke-static {v1}, Landroid/widget/TextView;->access$invoke-canPasteBaidu-5f7e1c(Landroid/widget/TextView;)Z
    ...
    #calls: Landroid/widget/TextView;->stopSelectionActionMode()V
    invoke-static {v1}, Landroid/widget/TextView;->access$invoke-stopSelectionActionMode-67c64f(Landroid/widget/TextView;)V
...
.method public show()V
    ...
    #calls: Landroid/widget/TextView;->canPasteBaidu()Z
    invoke-static {v8}, Landroid/widget/TextView;->access$invoke-canPasteBaidu-5f7e1c(Landroid/widget/TextView;)Z
    ...
    invoke-static {v8}, Landroid/widget/TextView;->access$invoke-isCursorInsideSuggestionSpan-d7afe5(Landroid/widget/TextView;)Z
    ...
    invoke-static {v8}, Landroid/widget/TextView;->access$invoke-canCopy-52ebbe(Landroid/widget/TextView;)Z
