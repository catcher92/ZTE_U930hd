...
.method private initDrawables()V
    ...
    invoke-static {v0}, Landroid/widget/TextView;->access$iget-mSelectHandleLeft-8865e1(Landroid/widget/TextView;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v2}, Landroid/widget/TextView;->access$iget-mTextSelectHandleLeftRes-3a7e4b(Landroid/widget/TextView;)I
    ...
    invoke-static {v0, v1}, Landroid/widget/TextView;->access$iput-mSelectHandleLeft-8bdc83(Landroid/widget/TextView;Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v0}, Landroid/widget/TextView;->access$iget-mSelectHandleRight-8c07fa(Landroid/widget/TextView;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v2}, Landroid/widget/TextView;->access$iget-mTextSelectHandleRightRes-22ed4c(Landroid/widget/TextView;)I
    ...
    invoke-static {v0, v1}, Landroid/widget/TextView;->access$iput-mSelectHandleRight-84f184(Landroid/widget/TextView;Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
...
.method private initHandles()V
    ...
    #getter for: Landroid/widget/TextView;->mSelectHandleLeft:Landroid/graphics/drawable/Drawable;
    invoke-static {v2}, Landroid/widget/TextView;->access$iget-mSelectHandleLeft-8865e1(Landroid/widget/TextView;)Landroid/graphics/drawable/Drawable;
    ...
    #getter for: Landroid/widget/TextView;->mSelectHandleRight:Landroid/graphics/drawable/Drawable;
    invoke-static {v3}, Landroid/widget/TextView;->access$iget-mSelectHandleRight-8c07fa(Landroid/widget/TextView;)Landroid/graphics/drawable/Drawable;
    ...
    #getter for: Landroid/widget/TextView;->mSelectHandleRight:Landroid/graphics/drawable/Drawable;
    invoke-static {v2}, Landroid/widget/TextView;->access$iget-mSelectHandleRight-8c07fa(Landroid/widget/TextView;)Landroid/graphics/drawable/Drawable;
    ...
    #getter for: Landroid/widget/TextView;->mSelectHandleLeft:Landroid/graphics/drawable/Drawable;
    invoke-static {v3}, Landroid/widget/TextView;->access$iget-mSelectHandleLeft-8865e1(Landroid/widget/TextView;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v0}, Landroid/widget/TextView;->access$invoke-hideInsertionPointCursorController-0c2700(Landroid/widget/TextView;)V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)V
    ...
    invoke-static {v7, v5, v6}, Landroid/widget/TextView;->access$invoke-isPositionOnText-7c3fc3(Landroid/widget/TextView;FF)Z
    ...
    invoke-static {v7}, Landroid/widget/TextView;->access$iget-mSquaredTouchSlopDistance-ec7117(Landroid/widget/TextView;)I
    ...
    invoke-static {v7}, Landroid/widget/TextView;->access$invoke-startSelectionActionMode-e243bb(Landroid/widget/TextView;)Z
    ...
    invoke-static {v7, v8}, Landroid/widget/TextView;->access$iput-mDiscardNextActionUp-c50cc3(Landroid/widget/TextView;Z)Z
    ...
    #getter for: Landroid/view/View;->mContext:Landroid/content/Context;
    invoke-static {v7}, Landroid/widget/TextView;->access$iget-mContext-3ebab7(Landroid/widget/TextView;)Landroid/content/Context;
