...
.method public constructor <init>(Landroid/widget/TextView;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-static {p1}, Landroid/widget/TextView;->access$iget-mContext-3ebab7(Landroid/widget/TextView;)Landroid/content/Context;
...
.method public hide()V
    ...
    invoke-static {v0}, Landroid/widget/TextView;->access$invoke-getPositionListener-f221e9(Landroid/widget/TextView;)Landroid/widget/TextView$PositionListener;
...
.method protected isVisible()Z
    ...
    invoke-static {v0, v1, v2}, Landroid/widget/TextView;->access$invoke-isPositionVisible-02712e(Landroid/widget/TextView;II)Z
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    #calls: Landroid/widget/TextView;->getPositionListener()Landroid/widget/TextView$PositionListener;
    invoke-static {v8}, Landroid/widget/TextView;->access$invoke-getPositionListener-f221e9(Landroid/widget/TextView;)Landroid/widget/TextView$PositionListener;
    ...
    #getter for: Landroid/widget/TextView;->mMagnifierController:Landroid/widget/TextView$MagnifierController;
    invoke-static {v8}, Landroid/widget/TextView;->access$iget-mMagnifierController-aadd0e(Landroid/widget/TextView;)Landroid/widget/TextView$MagnifierController;
...
.method protected positionAtCursorOffset(IZ)Z
    ...
    invoke-static {v4}, Landroid/widget/TextView;->access$invoke-prepareCursorControllers-a01c23(Landroid/widget/TextView;)V
    ...
    invoke-static {v3}, Landroid/widget/TextView;->access$iget-mSpacingMult-a57516(Landroid/widget/TextView;)F
    ...
    invoke-static {v3}, Landroid/widget/TextView;->access$iget-mSpacingAdd-fd82f6(Landroid/widget/TextView;)F
    ...
    invoke-static {v5}, Landroid/widget/TextView;->access$invoke-viewportToContentHorizontalOffset-bc200d(Landroid/widget/TextView;)I
    ...
    invoke-static {v5}, Landroid/widget/TextView;->access$invoke-viewportToContentVerticalOffset-4ef85b(Landroid/widget/TextView;)I
