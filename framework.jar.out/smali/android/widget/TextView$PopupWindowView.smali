...
.method private recordScreenSize()V
    ...
    #getter for: Landroid/view/View;->mContext:Landroid/content/Context;
    invoke-static {v0}, Landroid/widget/TextView;->access$iget-mContext-3ebab7(Landroid/widget/TextView;)Landroid/content/Context;
...
.method private updateBounds(ZIII)V
    ...
    #getter for: Landroid/view/View;->mContext:Landroid/content/Context;
    invoke-static {v6}, Landroid/widget/TextView;->access$iget-mContext-3ebab7(Landroid/widget/TextView;)Landroid/content/Context;
    ...
    invoke-static {v7}, Landroid/widget/TextView;->access$iget-mTextSelectHandleRes-aa2635(Landroid/widget/TextView;)I
    ...
    invoke-static {v6}, Landroid/widget/TextView;->access$iget-mSpacingMult-a57516(Landroid/widget/TextView;)F
    ...
    invoke-static {v6}, Landroid/widget/TextView;->access$iget-mSpacingAdd-fd82f6(Landroid/widget/TextView;)F
    ...
    invoke-static {v6, v7}, Landroid/widget/TextView;->access$invoke-convertFromViewportToContentCoordinates-5f38f4(Landroid/widget/TextView;Landroid/graphics/Rect;)V
    ...
    invoke-static {v8}, Landroid/widget/TextView;->access$iget-mRight-7e9bb5(Landroid/widget/TextView;)I
    ...
    invoke-static {v9}, Landroid/widget/TextView;->access$iget-mLeft-3535d4(Landroid/widget/TextView;)I
