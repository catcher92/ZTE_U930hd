...
.method public handleMessage(Landroid/os/Message;)V
    ...
    .line 888
    const-string v7, "Hardware/Camera/Camera"
    ...
    const-string v9, "CAMERA_MSG_CONTINUOUS_FOCUS..."
    ...
    #getter for: Landroid/hardware/Camera;->mContinuousFocusCallback:Landroid/hardware/Camera$ContinuousFocusCallback;
    invoke-static {v7}, Landroid/hardware/Camera;->access$900(Landroid/hardware/Camera;)Landroid/hardware/Camera$ContinuousFocusCallback;
    ...
    invoke-interface {v7, v8, v9}, Landroid/hardware/Camera$ContinuousFocusCallback;->onContinuousAutoFocus(ILandroid/hardware/Camera;)V
    ...
    invoke-static {v7}, Landroid/hardware/Camera;->access$1100(Landroid/hardware/Camera;)Landroid/hardware/Camera$FaceDetectionListener;
    ...
    invoke-static {v7}, Landroid/hardware/Camera;->access$1200(Landroid/hardware/Camera;)Landroid/hardware/Camera$ErrorCallback;
    ...
    invoke-static {v7}, Landroid/hardware/Camera;->access$1300(Landroid/hardware/Camera;)Landroid/hardware/Camera$SmileCallback;
    ...
    invoke-static {v7}, Landroid/hardware/Camera;->access$1400(Landroid/hardware/Camera;)Landroid/hardware/Camera$ASDCallback;
    ...
    invoke-static {v7}, Landroid/hardware/Camera;->access$1500(Landroid/hardware/Camera;)Landroid/hardware/Camera$MAVCallback;
    ...
    invoke-static {v7}, Landroid/hardware/Camera;->access$1600(Landroid/hardware/Camera;)Landroid/hardware/Camera$AUTORAMAMVCallback;
    ...
    invoke-static {v7}, Landroid/hardware/Camera;->access$1700(Landroid/hardware/Camera;)Landroid/hardware/Camera$AUTORAMACallback;
    ...
    invoke-static {v7}, Landroid/hardware/Camera;->access$1800(Landroid/hardware/Camera;)Landroid/hardware/Camera$AFDataCallback;
