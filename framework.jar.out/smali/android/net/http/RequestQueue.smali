...
.method private declared-synchronized setProxyConfig()V
    ...
    const-string v3, "RequestQueue.setProxyConfig "
...
.method public queueRequest(Ljava/lang/String;Landroid/net/WebAddress;Ljava/lang/String;Ljava/util/Map;Landroid/net/http/EventHandler;Ljava/io/InputStream;I)Landroid/net/http/RequestHandle;
    ...
    iget-object v12, p0, Landroid/net/http/RequestQueue;->mProxyHost:Lorg/apache/http/HttpHost;

    .line 359
    .local v12, proxyHost:Lorg/apache/http/HttpHost;
    invoke-static {}, Landroid/net/http/ExceptionHost;->enabled()Z
    ...
    invoke-static {v1}, Landroid/net/http/ExceptionHost;->isInExceptionHostList(Ljava/lang/String;)Z
...
.method public declared-synchronized setProxyHost(Ljava/lang/String;I)V
    ...
    const-string v1, "Enter setProxyHost host is "
    ...
    .line 302
    const-string/jumbo v0, "mProxyHost is  null"
