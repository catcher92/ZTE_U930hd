...
.method private setEnableApn(Ljava/lang/String;Z)I
    ...
    iget v4, p0, Landroid/net/MobileDataStateTracker;->mPid:I
    ...
    .line 546
    .local v1, expandedApnType:Ljava/lang/String;
    const/4 v2, 0x0
    ...
    .line 548
    const-string v3, "Ignoring feature request because could not acquire PhoneService"
    ...
    invoke-interface {v3, v1}, Lcom/android/internal/telephony/ITelephony;->enableApnType(Ljava/lang/String;)I
    ...
    invoke-interface {v3, v1}, Lcom/android/internal/telephony/ITelephony;->disableApnType(Ljava/lang/String;)I
    :try_end_0
...
.method public reconnect()Z
    ...
    const-string/jumbo v2, "reconnect, calling pid is "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    iget v2, p0, Landroid/net/MobileDataStateTracker;->mPid:I
...
.method public setPid(I)V
    ...
    .prologue
    .line 633
    iput p1, p0, Landroid/net/MobileDataStateTracker;->mPid:I
...
.method public teardown()Z
    ...
    const-string/jumbo v3, "teardown, calling pid is "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    iget v3, p0, Landroid/net/MobileDataStateTracker;->mPid:I
