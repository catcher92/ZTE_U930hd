...
.field protected static final APN_CMNET_ID:I = 0x8

.field protected static final APN_CMWAP_ID:I = 0x9
...
.field protected static final APN_TV_ID:I = 0xa
...
.field protected static final EVENT_NETWORK_ATTACH:I = 0x42021

.field protected static final EVENT_NV_READY:I = 0x42015

.field protected static final EVENT_NW_TYPE_CHANGED:I = 0x42022
...
.field protected static final INTENT_ACTION_BROWSER_USING_PS:Ljava/lang/String; = "usingPS"

.field protected static final INTENT_ACTION_BROWSER_USING_WIFI:Ljava/lang/String; = "usingWlan"
...
.method protected constructor <init>(Lcom/android/internal/telephony/PhoneBase;)V
    ...
    .line 292
    iput-boolean v8, p0, Lcom/android/internal/telephony/DataConnectionTracker;->mAutoAttachOnCreation:Z
    ...
    .line 524
    const-string/jumbo v0, "usingPS"

    invoke-virtual {v6, v0}, Landroid/content/IntentFilter;->addAction(Ljava/lang/String;)V

    .line 525
    const-string/jumbo v0, "usingWlan"
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    iget-object v10, v2, Lcom/android/internal/telephony/DataConnectionAc;->dataConnection:Lcom/android/internal/telephony/DataConnection;
    ...
    .line 690
    .local v4, expandedApnType:Ljava/lang/String;
    const-string v10, ","
    ...
    invoke-virtual {p0, v10, v9, v11}, Lcom/android/internal/telephony/DataConnectionTracker;->onEnableApn(III)V

    goto :goto_0

    .line 695
    .end local v4           #expandedApnType:Ljava/lang/String;
    ...
    const-string v10, "CMD_SET_USER_DATA_ENABLE enabled="
...
.method protected onEnableApn(III)V
    .locals 6
    .parameter "apnId"
    .parameter "pid"
    .parameter "enabled"
...
.method protected onSetPolicyDataEnabled(Z)V
    ...
    sget-boolean v3, Lcom/android/internal/telephony/DataConnectionTracker;->sPolicyDataEnabled:Z
...
.method protected onSetUserDataEnabled(Z)V
    ...
    invoke-virtual {p0, v5}, Lcom/android/internal/telephony/DataConnectionTracker;->apnTypeToId(Ljava/lang/String;)I

    move-result v5

    const-string v6, "dataDisabled"

    invoke-virtual {p0, v3, v5, v6}, Lcom/android/internal/telephony/DataConnectionTracker;->onCleanUpConnection(ZILjava/lang/String;)V
...
.method protected setEnabled(ILjava/lang/String;Z)V
    .locals 3
    .parameter "id"
    .parameter "pid"
    .parameter "enable"
