...
.field private mHasPreferApnSet:Z

.field private mIsApnChanging:Z

.field private mPollNetStat:Ljava/lang/Runnable;

.field private mRadioTechnology:Ljava/lang/String;
...
.method public constructor <init>(Lcom/android/internal/telephony/PhoneBase;)V
    ...
    .line 85
    iput-boolean v2, p0, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->mIsApnChanging:Z
    ...
    .line 141
    iput-boolean v2, p0, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->mHasPreferApnSet:Z

    .line 142
    const-string/jumbo v1, "unknown"

    iput-object v1, p0, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->mRadioTechnology:Ljava/lang/String;
    ...
    invoke-virtual {v1, p0, v2, v3}, Lcom/android/internal/telephony/ServiceStateTracker;->registerForNetworkAttached(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    invoke-virtual {v1, p0, v2, v3}, Lcom/android/internal/telephony/ServiceStateTracker;->registerForNwTypeChanged(Landroid/os/Handler;ILjava/lang/Object;)V
...
.method private cleanUpConnection(ZLcom/android/internal/telephony/ApnContext;)V
    ...
    .line 964
    const-string v3, "cleanUpConnection: apnlist is empty"

    invoke-virtual {p0, v3}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->log(Ljava/lang/String;)V

    .line 965
    iget-boolean v3, p0, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->mIsApnChanging:Z
    ...
    invoke-virtual {v3, v4, v2}, Lcom/android/internal/telephony/DataConnection;->tearDownAll(Ljava/lang/String;Landroid/os/Message;)V
...
.method private createAllApnList()V
    ...
    .line 2280
    invoke-direct {p0, v8}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->createApnList(Landroid/database/Cursor;)Ljava/util/ArrayList;
    ...
    invoke-virtual {v6, v0}, Lcom/android/internal/telephony/ApnSetting;->canHandleType(Ljava/lang/String;)Z
    ...
    .line 2300
    iget v0, v6, Lcom/android/internal/telephony/ApnSetting;->id:I
    ...
    const-string v1, ",after prefer apn is set"
    ...
    invoke-interface {v0}, Landroid/net/IConnectivityManager;->isTetheringSupported()Z

    move-result v11

    .line 2316
    .local v11, isTetherEnable:Z
    if-eqz v11, :cond_2

    .line 2317
    invoke-direct {p0}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->formatDunApnInternal()Ljava/lang/String;

    move-result-object v7

    .line 2318
    .local v7, apnData:Ljava/lang/String;
    if-eqz v7, :cond_2
    ...
    const-string v1, "createAllApnList: set dun apn to "
    ...
    .line 2326
    .end local v7           #apnData:Ljava/lang/String;
    .end local v11           #isTetherEnable:Z
    :catch_0
    move-exception v9
...
.method private createDataConnection()Lcom/android/internal/telephony/gsm/GsmDataConnection;
    ...
    .line 2343
    const-string v10, "createDataConnection E"
    ...
    .line 2347
    .local v0, ac:Lcom/android/internal/telephony/DataConnectionAc;
    ...
    .line 2351
    .end local v0           #ac:Lcom/android/internal/telephony/DataConnectionAc;
    :cond_1
    new-instance v10, Ljava/lang/StringBuilder;

    invoke-direct {v10}, Ljava/lang/StringBuilder;-><init>()V

    const-string v11, "createDataConnection() active pdp size = "
    ...
    .line 2353
    const-string v10, "createDataConnection() active pdp size limit meet!"
    ...
    .line 2357
    :cond_2
    new-instance v7, Lcom/android/internal/telephony/RetryManager;

    invoke-direct {v7}, Lcom/android/internal/telephony/RetryManager;-><init>()V

    .line 2358
    .local v7, rm:Lcom/android/internal/telephony/RetryManager;
    iget-object v10, p0, Lcom/android/internal/telephony/DataConnectionTracker;->mUniqueIdGenerator:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-static {v10, v6, v7}, Lcom/android/internal/telephony/gsm/GsmDataConnection;->makeDataConnection(Lcom/android/internal/telephony/PhoneBase;ILcom/android/internal/telephony/RetryManager;)Lcom/android/internal/telephony/gsm/GsmDataConnection;

    move-result-object v2

    .line 2360
    .local v2, conn:Lcom/android/internal/telephony/gsm/GsmDataConnection;
    iget-object v10, p0, Lcom/android/internal/telephony/DataConnectionTracker;->mDataConnections:Ljava/util/HashMap;
    ...
    .line 2361
    new-instance v3, Lcom/android/internal/telephony/DataConnectionAc;

    const-string v10, "GSM"

    invoke-direct {v3, v2, v10}, Lcom/android/internal/telephony/DataConnectionAc;-><init>(Lcom/android/internal/telephony/DataConnection;Ljava/lang/String;)V
    ...
    invoke-virtual {v2}, Lcom/android/internal/telephony/gsm/GsmDataConnection;->getHandler()Landroid/os/Handler;

    move-result-object v11

    invoke-virtual {v3, v10, p0, v11}, Lcom/android/internal/telephony/DataConnectionAc;->fullyConnectSync(Landroid/content/Context;Landroid/os/Handler;Landroid/os/Handler;)I
    ...
    iget-object v11, v3, Lcom/android/internal/telephony/DataConnectionAc;->dataConnection:Lcom/android/internal/telephony/DataConnection;

    invoke-virtual {v11}, Lcom/android/internal/telephony/DataConnection;->getDataConnectionId()I
    ...
    const-string v11, "com.android.internal.telephony.gprs-reconnect."
    ...
    iget-object v11, p0, Lcom/android/internal/telephony/DataConnectionTracker;->mIntentReceiver:Landroid/content/BroadcastReceiver;
    ...
    invoke-virtual {v10, v11, v4, v9, v12}, Landroid/content/Context;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;Ljava/lang/String;Landroid/os/Handler;)Landroid/content/Intent;
    ...
    const-string v10, "createDataConnection() X id="
    ...
    const-string v11, "createDataConnection: Could not connect to dcac.mDc="
...
.method private formatDunApnInternal()Ljava/lang/String;
    .locals 7
    ...
    invoke-virtual {v3}, Lcom/android/internal/telephony/gsm/SIMRecords;->getMncLength()I
    ...
    .line 2338
    .local v0, mccLength:I
    const-string v3, "CMCC NET,cmnet,,,cmnet,cmnet,,,,,%s,%s,,DUN"
...
.method private getDefaultDataEnabled()Z
    .locals 2
...
.method private onApnChanged()V
    ...
    .line 1165
    iget-boolean v2, p0, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->mHasPreferApnSet:Z

    if-eqz v2, :cond_0

    .line 1166
    iput-boolean v4, p0, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->mHasPreferApnSet:Z
    ...
    .line 1170
    .local v0, defaultApnContext:Lcom/android/internal/telephony/ApnContext;
    invoke-virtual {v0}, Lcom/android/internal/telephony/ApnContext;->isDisconnected()Z

    move-result v1

    .line 1172
    .local v1, defaultApnIsDisconnected:Z
    iget-object v2, p0, Lcom/android/internal/telephony/DataConnectionTracker;->mPhone:Lcom/android/internal/telephony/PhoneBase;
    ...
    .line 1181
    iput-boolean v3, p0, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->mIsApnChanging:Z
    ...
    :goto_1
    invoke-direct {p0, v2, v0}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->cleanUpConnection(ZLcom/android/internal/telephony/ApnContext;)V
...
.method private onNetworkAttach()V
    .locals 2
    ...
    iput-object v0, p0, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->mRadioTechnology:Ljava/lang/String;
    ...
    .line 2649
    const-string/jumbo v0, "onNetworkAttach(): notifying data availability"
    ...
    .line 2652
    :cond_0
    const-string/jumbo v0, "networkAttached"
...
.method private onNwTypeChanged()V
    .locals 3
    ...
    iget-object v2, p0, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->mRadioTechnology:Ljava/lang/String;
    ...
    .line 2660
    .local v0, newRadioTechnology:Ljava/lang/String;
    iget-object v1, p0, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->mRadioTechnology:Ljava/lang/String;
    ...
    .line 2661
    const-string/jumbo v1, "onNwTypeChanged():network has not been changed"
    ...
    .line 2663
    :cond_0
    const-string/jumbo v1, "onNwTypeChanged():notify off apns of availability"
    ...
    .line 2665
    const-string/jumbo v1, "nwTypeChanged"
...
.method private retryAfterDisconnected(Ljava/lang/String;Ljava/lang/String;)Z
    .locals 2
    .parameter "reason"
    .parameter "apnType"
...
.method public declared-synchronized disableApnType(Ljava/lang/String;)I
    ...
    invoke-virtual {p0, v3, v4, v5}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->setEnabled(ILjava/lang/String;Z)V
...
.method public declared-synchronized enableApnType(Ljava/lang/String;)I
    ...
    invoke-virtual {p0, v4}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->isApnTypeAvailable(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, v2, v4, v5}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->setEnabled(ILjava/lang/String;Z)V
...
.method protected fetchDunApn()Lcom/android/internal/telephony/ApnSetting;
    ...
    .line 1849
    invoke-super {p0}, Lcom/android/internal/telephony/DataConnectionTracker;->fetchDunApn()Lcom/android/internal/telephony/ApnSetting;

    move-result-object v1

    .line 1851
    .end local v1           #dunSetting:Lcom/android/internal/telephony/ApnSetting;
    :cond_0
    return-object v1
.end method
...
.method public getAnyDataEnabled()Z
    ...
    const-string v6, "getAnyDataEnabled(): mInternalDataEnabled = "
    ...
    sget-boolean v6, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->sPolicyDataEnabled:Z
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    .end local v0           #tearDown:Z
    :sswitch_b
    invoke-direct {p0}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->onNetworkAttach()V

    goto/16 :goto_0

    .line 2634
    :sswitch_c
    const-string v1, "EVENT_NW_TYPE_CHANGED"

    invoke-virtual {p0, v1}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->log(Ljava/lang/String;)V

    .line 2635
    invoke-direct {p0}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->onNwTypeChanged()V
...
.method protected isDataAllowed()Z
    ...
    iget-object v10, v10, Lcom/android/internal/telephony/ServiceStateTracker;->ss:Landroid/telephony/ServiceState;
    ...
    .line 679
    .local v1, currentRadioTechnology:Ljava/lang/String;
    iget-object v10, p0, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->mRadioTechnology:Ljava/lang/String;
    ...
    invoke-virtual {v10}, Lcom/android/internal/telephony/IccRecords;->getRecordsLoaded()Z
    ...
    .end local v1           #currentRadioTechnology:Ljava/lang/String;
    .end local v2           #desiredPowerState:Z
    .end local v3           #gprsState:I
    .end local v4           #hasNetworkAttach:Z
    ...
    .restart local v1       #currentRadioTechnology:Ljava/lang/String;
    .restart local v4       #hasNetworkAttach:Z
    :cond_e
    move v5, v9
...
.method protected isDataPossible(Ljava/lang/String;)Z
    ...
    .line 276
    .local v2, possible:Z
    const-string v4, "isDataPossible(%s): possible=%b isDataAllowed=%b "
...
.method protected onActionIntentReconnectAlarm(Landroid/content/Intent;)V
    ...
    iget-boolean v6, p0, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->mIsApnChanging:Z
    ...
    .line 157
    const-string v6, "GPRS reconnect alarm. apnlist is empty,call setupDataOnReadyApns"

    invoke-virtual {p0, v6}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->log(Ljava/lang/String;)V

    .line 158
    iput-boolean v8, p0, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->mIsApnChanging:Z
    ...
    invoke-virtual {v3, v6}, Lcom/android/internal/telephony/DataConnectionAc;->setReconnectIntentSync(Landroid/app/PendingIntent;)V
    ...
    .line 161
    .restart local v1       #apnList:Ljava/util/Collection;,"Ljava/util/Collection<Lcom/android/internal/telephony/ApnContext;>;"
    :cond_2
    invoke-virtual {v3}, Lcom/android/internal/telephony/DataConnectionAc;->getApnListSync()Ljava/util/Collection;
...
.method protected onDataSetupComplete(Landroid/os/AsyncResult;)V
    ...
    const-string/jumbo v20, "onDataSetupCompete: No dcac"
    ...
    .line 1993
    .end local v11           #dcac:Lcom/android/internal/telephony/DataConnectionAc;
    :cond_0
    new-instance v19, Ljava/lang/RuntimeException;

    const-string/jumbo v20, "onDataSetupComplete: No apnContext"
    ...
    .line 2001
    .restart local v11       #dcac:Lcom/android/internal/telephony/DataConnectionAc;
    :cond_1
    ...
    .line 2006
    .local v10, dc:Lcom/android/internal/telephony/DataConnection;
    const-string v6, "<unknown>"

    .line 2007
    .local v6, apnStr:Ljava/lang/String;
    ...
    check-cast v19, Lcom/android/internal/telephony/ApnSetting;
    ...
    const-string/jumbo v20, "onDataSetupComplete: success apn="
    ...
    .line 2014
    invoke-virtual {v5}, Lcom/android/internal/telephony/ApnContext;->getPid()I
    ...
    .line 2016
    invoke-virtual {v11, v15}, Lcom/android/internal/telephony/DataConnectionAc;->setLinkPropertiesProcessID(I)V
    ...
    invoke-virtual {v11, v0}, Lcom/android/internal/telephony/DataConnectionAc;->setLinkPropertiesHttpProxySync(Landroid/net/ProxyProperties;)V
    :try_end_0
    ...
    .line 2035
    .local v13, ia:Ljava/util/Iterator;,"Ljava/util/Iterator<Ljava/net/InetAddress;>;"
    invoke-interface {v13}, Ljava/util/Iterator;->hasNext()Z
    ...
    const-string v19, "gsm.defaultpdpcontext.address"
    ...
    const-string/jumbo v20, "onDataSetupComplete: set default ip address to "
    ...
    :cond_6
    const-string v19, "gsm.defaultpdpcontext.active"
    ...
    iget-object v0, v0, Lcom/android/internal/telephony/DataConnectionTracker;->mPreferredApn:Lcom/android/internal/telephony/ApnSetting;
    ...
    .line 2045
    const-string/jumbo v19, "onDataSetupComplete: PREFERED APN is null"
    ...
    iput-object v0, v1, Lcom/android/internal/telephony/DataConnectionTracker;->mPreferredApn:Lcom/android/internal/telephony/ApnSetting;
    ...
    .line 2054
    .end local v13           #ia:Ljava/util/Iterator;,"Ljava/util/Iterator<Ljava/net/InetAddress;>;"
    :cond_7
    :goto_1
    move-object/from16 v0, p0
    ...
    .end local v6           #apnStr:Ljava/lang/String;
    .end local v10           #dc:Lcom/android/internal/telephony/DataConnection;
    .end local v11           #dcac:Lcom/android/internal/telephony/DataConnectionAc;
    .end local v15           #pid:I
    :goto_2
    return-void
    ...
    .restart local v6       #apnStr:Ljava/lang/String;
    .restart local v10       #dc:Lcom/android/internal/telephony/DataConnection;
    .restart local v11       #dcac:Lcom/android/internal/telephony/DataConnectionAc;
    ...
    const-string/jumbo v20, "onDataSetupComplete: NumberFormatException making ProxyProperties ("
    ...
    check-cast v19, Lcom/android/internal/telephony/DataConnection$FailCause;
    ...
    .line 2066
    .local v7, apnString:Ljava/lang/String;
    :goto_3
    ...
    .line 2068
    invoke-virtual {v8}, Lcom/android/internal/telephony/DataConnection$FailCause;->isEventLoggable()Z
    ...
    .line 2078
    :cond_b
    invoke-virtual {v5}, Lcom/android/internal/telephony/ApnContext;->removeNextWaitingApn()V

    .line 2080
    const-string/jumbo v19, "onDataSetupComplete: WaitingApns.size=%d WaitingApnsPermFailureCountDown=%d"
    ...
    .line 2090
    const-string/jumbo v19, "onDataSetupComplete: All APN\'s had permanent failures, stop retrying"
    ...
    .line 2092
    sget-object v19, Lcom/android/internal/telephony/DataConnectionTracker$State;->FAILED:Lcom/android/internal/telephony/DataConnectionTracker$State;

    move-object/from16 v0, v19

    invoke-virtual {v5, v0}, Lcom/android/internal/telephony/ApnContext;->setState(Lcom/android/internal/telephony/DataConnectionTracker$State;)V
    ...
    const-string/jumbo v20, "onDataSetupComplete: permanent error apn=%s"
    ...
    .line 2063
    .end local v7           #apnString:Ljava/lang/String;
    :catch_1
    move-exception v12
    ...
    .restart local v7       #apnString:Ljava/lang/String;
    goto/16 :goto_3

    .line 2101
    .end local v12           #e:Ljava/lang/Exception;
    :cond_c
    const-string/jumbo v19, "onDataSetupComplete: Not all permanent failures, retry"
    ...
    check-cast v19, Lcom/android/internal/telephony/DataConnection$CallSetupException;

    invoke-virtual/range {v19 .. v19}, Lcom/android/internal/telephony/DataConnection$CallSetupException;->getRetryOverride()I
    ...
    .line 2109
    const-string v19, "No retry is suggested."
    ...
    invoke-direct {v0, v8, v5, v1}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->startDelayedRetry(Lcom/android/internal/telephony/DataConnection$FailCause;Lcom/android/internal/telephony/ApnContext;I)V

    goto/16 :goto_2

    .line 2115
    .end local v18           #retryOverride:I
    :cond_f
    const-string/jumbo v19, "onDataSetupComplete: Try next APN"
    ...
    .line 2116
    sget-object v19, Lcom/android/internal/telephony/DataConnectionTracker$State;->SCANNING:Lcom/android/internal/telephony/DataConnectionTracker$State;
    ...
    .line 2119
    sget v19, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->APN_DELAY_MILLIS:I
...
.method protected onDisconnectDone(ILandroid/os/AsyncResult;)V
    ...
    .line 2150
    invoke-virtual {v0, v5}, Lcom/android/internal/telephony/ApnContext;->setPid(I)V
    ...
    invoke-direct {p0, v1, v2}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->retryAfterDisconnected(Ljava/lang/String;Ljava/lang/String;)Z
...
.method protected onEnableApn(III)V
    ...
    .line 1892
    invoke-virtual {v0, p2}, Lcom/android/internal/telephony/ApnContext;->setPid(I)V
    ...
    invoke-virtual {v0, v2}, Lcom/android/internal/telephony/ApnContext;->setPid(I)V
