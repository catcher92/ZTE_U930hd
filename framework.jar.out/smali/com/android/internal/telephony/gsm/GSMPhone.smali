...
.field public static final OPERATOR_ALPHA_LONG_CMCC_3G:Ljava/lang/String; = "CHINA  MOBILE 3G"

.field public static final OPERATOR_NUMERIC_CMCC:Ljava/lang/String; = "46000"

.field public static final OPERATOR_NUMERIC_CMCC_3G:Ljava/lang/String; = "46088"

.field public static final USSD_DCS_16_BIT:I = 0x48

.field public static final USSD_DCS_7_BIT:I = 0xf

.field public static final USSD_DCS_8_BIT:I = 0x44

.field public static final USSD_DCS_UNKNOWN:I = 0xff
...
.method private handleCfuQueryResult([Lcom/android/internal/telephony/CallForwardInfo;)V
    ...
    :goto_2
    invoke-virtual {v5, v3, v2}, Lcom/android/internal/telephony/IccRecords;->setVoiceCallForwardingFlag(IZ)V
    ...
    :cond_5
    invoke-virtual {v2, v3, v4}, Lcom/android/internal/telephony/gsm/SIMRecords;->setVideoCallForwardingFlag(IZ)V
...
.method private onIncomingUSSD(ILjava/lang/String;I)V
    .locals 12
    .parameter "ussdMode"
    ...
    const-string/jumbo v11, "ussdMode: "
    ...
    .line 1285
    .local v4, isUssdError:Z
    :goto_2
    const/4 v2, 0x0

    .line 1286
    .local v2, found:Lcom/android/internal/telephony/gsm/GsmMmiCode;
    const/4 v3, 0x0
    ...
    .end local v2           #found:Lcom/android/internal/telephony/gsm/GsmMmiCode;
    check-cast v2, Lcom/android/internal/telephony/gsm/GsmMmiCode;

    .line 1293
    .restart local v2       #found:Lcom/android/internal/telephony/gsm/GsmMmiCode;
    :cond_1
    if-eqz v2, :cond_7
    ...
    .line 1261
    .restart local v1       #ex:Ljava/io/UnsupportedEncodingException;
    const/4 v8, 0x0
    ...
    .restart local v4       #isUssdError:Z
    ...
    .line 1299
    :cond_6
    invoke-virtual {v2, p2, v5}, Lcom/android/internal/telephony/gsm/GsmMmiCode;->onUssdFinished(Ljava/lang/String;Z)V
    ...
    .line 1308
    invoke-static {p2, v5, p0}, Lcom/android/internal/telephony/gsm/GsmMmiCode;->newNetworkInitiatedUssd(Ljava/lang/String;ZLcom/android/internal/telephony/gsm/GSMPhone;)Lcom/android/internal/telephony/gsm/GsmMmiCode;
...
.method public clearImei(Landroid/os/Message;)V
    ...
    invoke-interface {v0, p1}, Lcom/android/internal/telephony/CommandsInterface;->clearImei(Landroid/os/Message;)V
...
.method public confirmCall(IZLandroid/os/Message;)V
    ...
    invoke-interface {v0, p1, p2, p3}, Lcom/android/internal/telephony/CommandsInterface;->confirmCall(IZLandroid/os/Message;)V
...
.method public deativePdp(Landroid/os/Message;)V
    ...
    const-string v1, "deativePdp gsm"
...
.method public deleteCalibration(ILandroid/os/Message;)V
    ...
    const-string v1, "deleteCalibration gsm"
...
.method public deleteSnNumber(Landroid/os/Message;)V
    ...
    const-string v1, "deleteSnNumber gsm"
...
.method public fallback()V
    ...
    invoke-virtual {v0, v1}, Lcom/android/internal/telephony/gsm/GsmCallTracker;->hangupVideoCall(I)V
...
.method public getCallForwardingOption(IILandroid/os/Message;)V
    ...
    const-string/jumbo v3, "requesting call forwarding query.ServiceClass="
...
.method public getPinRemainAttempt(Landroid/os/Message;)V
    ...
    invoke-interface {v0, p1}, Lcom/android/internal/telephony/CommandsInterface;->getPinRemainAttempt(Landroid/os/Message;)V
...
.method public getadjust(Landroid/os/Message;)V
    ...
    invoke-interface {v0, p1}, Lcom/android/internal/telephony/CommandsInterface;->getadjust(Landroid/os/Message;)V
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    .line 1358
    invoke-virtual {p0}, Lcom/android/internal/telephony/gsm/GSMPhone;->syncColpSetting()V
    ...
    invoke-direct {p0, v9, v10, v11}, Lcom/android/internal/telephony/gsm/GSMPhone;->onIncomingUSSD(ILjava/lang/String;I)V
    :try_end_0
...
.method public hangupVideoCall()V
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/android/internal/telephony/CallStateException;
...
.method public notifyVideoCallForwardingIndicator()V
    .locals 2
    ...
    const-string/jumbo v1, "notifyVideoCallForwardingIndicator"
    ...
    invoke-interface {v0, p0}, Lcom/android/internal/telephony/PhoneNotifier;->notifyVideoCallForwardingChanged(Lcom/android/internal/telephony/Phone;)V
...
.method public query3Gqos(Landroid/os/Message;)V
    ...
    const-string/jumbo v1, "query3Gqos gsm"
    ...
    invoke-interface {v0, p1}, Lcom/android/internal/telephony/CommandsInterface;->query3Gqos(Landroid/os/Message;)V
...
.method public queryCalibration(ILandroid/os/Message;)V
    ...
    const-string/jumbo v1, "queryCalibration gsm"
...
.method public queryLcdFlag(Landroid/os/Message;)V
    ...
    const-string/jumbo v1, "queryLcdFlag gsm"
...
.method public queryProduceMode(Landroid/os/Message;)V
    ...
    const-string/jumbo v1, "query the produce-mode mark GsmPhone"
    ...
    invoke-interface {v0, p1}, Lcom/android/internal/telephony/CommandsInterface;->queryProduceMode(Landroid/os/Message;)V
...
.method public querySnNumber(Landroid/os/Message;)V
    ...
    const-string/jumbo v1, "querySnNumber gsm"
...
.method public registerForIncomingMTCall(Landroid/os/Handler;ILjava/lang/Object;)V
    .locals 1
    .parameter "h"
    .parameter "what"
    .parameter "obj"
    ...
    invoke-interface {v0, p1, p2, p3}, Lcom/android/internal/telephony/CommandsInterface;->registerForIncomingMTCall(Landroid/os/Handler;ILjava/lang/Object;)V
...
.method public request3Gqos(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/os/Message;)V
    ...
    const-string/jumbo v1, "request3Gqos gsm"
...
.method public saveColrSetting(I)V
    .locals 4
    .parameter "commandInterfaceCOLPMode"
    ...
    const-string v3, "failed to commit COLP preference"
...
.method public selectNetworkManually(Lcom/android/internal/telephony/OperatorInfo;Landroid/os/Message;)V
    ...
    const-string v4, "CHINA  MOBILE 3G"
    ...
    invoke-interface {v3, v2, v0}, Lcom/android/internal/telephony/CommandsInterface;->setNetworkSelectionModeManual(Ljava/lang/String;Landroid/os/Message;)V
...
.method public setCpReset(ILandroid/os/Message;)V
    ...
    const-string/jumbo v1, "setCpReset gsm"
    ...
    invoke-interface {v0, p1, p2}, Lcom/android/internal/telephony/CommandsInterface;->setCpReset(ILandroid/os/Message;)V
...
.method public setGprs(Landroid/os/Message;Ljava/lang/String;)V
    ...
    const-string/jumbo v1, "setGprs gsm"
...
.method public setLcdFlag(Ljava/lang/String;Landroid/os/Message;)V
    ...
    invoke-interface {v0, p1, p2}, Lcom/android/internal/telephony/CommandsInterface;->setLcdFlag(Ljava/lang/String;Landroid/os/Message;)V
...
.method public setSnNumber(Ljava/lang/String;Landroid/os/Message;)V
    ...
    invoke-interface {v0, p1, p2}, Lcom/android/internal/telephony/CommandsInterface;->setSnNumber(Ljava/lang/String;Landroid/os/Message;)V
...
.method public setinfoperiodicmode(Landroid/os/Message;)V
    ...
    const-string/jumbo v1, "setinfoperiodicmode gsm"
    ...
    invoke-interface {v0, p1}, Lcom/android/internal/telephony/CommandsInterface;->setinfoperiodicmode(Landroid/os/Message;)V
...
.method public setupDataCall(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/os/Message;)V
    ...
    const-string/jumbo v1, "setupDataCall gsm"
...
.method public shutDownRadio(Landroid/os/Message;)V
    ...
    invoke-interface {v0, p1}, Lcom/android/internal/telephony/CommandsInterface;->shutDownRadio(Landroid/os/Message;)V
...
.method public switchtocsSms(Landroid/os/Message;)V
    ...
    const-string/jumbo v1, "switchtopsSms gsm"
    ...
    invoke-interface {v0, p1}, Lcom/android/internal/telephony/CommandsInterface;->switchtocsSms(Landroid/os/Message;)V
...
.method public switchtopsSms(Landroid/os/Message;)V
    ...
    invoke-interface {v0, p1}, Lcom/android/internal/telephony/CommandsInterface;->switchtopsSms(Landroid/os/Message;)V
...
.method protected syncColpSetting()V
    .locals 4
    ...
    invoke-interface {v2, v0, v3}, Lcom/android/internal/telephony/CommandsInterface;->setCOLP(ILandroid/os/Message;)V
...
.method public turnoffinfoperiodicmode(Landroid/os/Message;)V
    ...
    const-string/jumbo v1, "turnoffinfoperiodicmode gsm"
    ...
    invoke-interface {v0, p1}, Lcom/android/internal/telephony/CommandsInterface;->turnoffinfoperiodicmode(Landroid/os/Message;)V

    .line 1882
    return-void
.end method

.method public unregisterForIncomingMTCall(Landroid/os/Handler;)V
    .locals 1
    .parameter "h"
    ...
    invoke-interface {v0, p1}, Lcom/android/internal/telephony/CommandsInterface;->unregisterForIncomingMTCall(Landroid/os/Handler;)V
...
.method public vtAcceptCall()V
    ...
    invoke-virtual {v0}, Lcom/android/internal/telephony/gsm/GsmCallTracker;->vtAcceptCall()V
...
.method public vtdial(Ljava/lang/String;)Lcom/android/internal/telephony/Connection;
    ...
    invoke-virtual {v3, v4, v5}, Lcom/android/internal/telephony/gsm/GsmCallTracker;->vtdial(Ljava/lang/String;I)Lcom/android/internal/telephony/Connection;
    ...
    invoke-virtual {v3, v2, v4}, Lcom/android/internal/telephony/gsm/GsmCallTracker;->vtdial(Ljava/lang/String;I)Lcom/android/internal/telephony/Connection;
...
.method public writeCalibration(ILandroid/os/Message;)V
    ...
    const-string/jumbo v1, "writeCalibration gsm"
...
.method public writeSensorCalibration(ILandroid/os/Message;)V
    ...
    const-string/jumbo v1, "write sensor Calibration gsm"
