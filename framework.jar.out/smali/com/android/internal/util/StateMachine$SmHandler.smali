...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/internal/util/StateMachine$SmHandler;->mLockObj:Ljava/lang/Object;
...
.method private final completeConstruction()V
    ...
    .line 898
    sget-object v6, Lcom/android/internal/util/StateMachine$SmHandler;->mLockObj:Ljava/lang/Object;
    ...
    .line 900
    sget-object v5, Lcom/android/internal/util/StateMachine$SmHandler;->mLockObj:Ljava/lang/Object;
    ...
    const-string v7, "completeConstruction: notify to continue other transitions"
...
.method private final processMsg(Landroid/os/Message;)V
    ...
    .line 915
    .local v1, logFlag:Z
    #calls: Lcom/android/internal/util/StateMachine;->isPrintLogInfo()Z
    invoke-static {}, Lcom/android/internal/util/StateMachine;->access$300()Z
    ...
    const-string/jumbo v5, "processMsg = "
    ...
    invoke-virtual {v3, p1}, Lcom/android/internal/util/State;->processMessage(Landroid/os/Message;)Z
    ...
    invoke-virtual {v3, p1}, Lcom/android/internal/util/StateMachine;->unhandledMessage(Landroid/os/Message;)V
    ...
    invoke-direct {p0, v3}, Lcom/android/internal/util/StateMachine$SmHandler;->transitionTo(Lcom/android/internal/util/IState;)V
    ...
    iget-object v2, v3, Lcom/android/internal/util/StateMachine$SmHandler$StateInfo;->state:Lcom/android/internal/util/State;

    .line 950
    .local v2, orgState:Lcom/android/internal/util/State;
    iget-object v3, p0, Lcom/android/internal/util/StateMachine$SmHandler;->mProcessedMessages:Lcom/android/internal/util/StateMachine$ProcessedMessages;

    iget-object v4, v0, Lcom/android/internal/util/StateMachine$SmHandler$StateInfo;->state:Lcom/android/internal/util/State;

    invoke-virtual {v3, p1, v4, v2}, Lcom/android/internal/util/StateMachine$ProcessedMessages;->add(Landroid/os/Message;Lcom/android/internal/util/State;Lcom/android/internal/util/State;)V

    .line 954
    .end local v2           #orgState:Lcom/android/internal/util/State;
    :goto_1
    return-void
    ...
    invoke-virtual {v3, p1, v6, v6}, Lcom/android/internal/util/StateMachine$ProcessedMessages;->add(Landroid/os/Message;Lcom/android/internal/util/State;Lcom/android/internal/util/State;)V
...
.method public final handleMessage(Landroid/os/Message;)V
    ...
    const-string v3, "handleMessage: wait for construction completed"

    invoke-static {v2, v3}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 749
    :cond_2
    sget-object v3, Lcom/android/internal/util/StateMachine$SmHandler;->mLockObj:Ljava/lang/Object;
    ...
    .line 753
    :try_start_1
    sget-object v2, Lcom/android/internal/util/StateMachine$SmHandler;->mLockObj:Ljava/lang/Object;
